    ...
    <main className="home">
      ...
      <section id="about">
        ...
        <p  className="about-body">
          ...
          I have 1 year of experience.</b> Please check my works <Link to="/work">here</Link> or in my <a href="https://brandon-portfolio-phi.vercel.app" target="_blank">other site</a>.
